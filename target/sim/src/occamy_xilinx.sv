...
(
    ...
    output logic             [  4:0] m_axi_hbm_0_awid,
    ...
    output logic             [  4:0] m_axi_hbm_0_arid,
    ...
    input  logic             [  4:0] m_axi_hbm_0_rid,
    ...
    input  logic             [  4:0] m_axi_hbm_0_bid,
    ...
    output logic             [  4:0] m_axi_hbm_1_awid,
    ...
    output logic             [  4:0] m_axi_hbm_1_arid,
    ...
    input  logic             [  4:0] m_axi_hbm_1_rid,
    ...
    input  logic             [  4:0] m_axi_hbm_1_bid,
    ...
    output logic             [  4:0] m_axi_hbm_2_awid,
    ...
    output logic             [  4:0] m_axi_hbm_2_arid,
    ...
    input  logic             [  4:0] m_axi_hbm_2_rid,
    ...
    input  logic             [  4:0] m_axi_hbm_2_bid,
    ...
    output logic             [  4:0] m_axi_hbm_3_awid,
    ...
    output logic             [  4:0] m_axi_hbm_3_arid,
    ...
    input  logic             [  4:0] m_axi_hbm_3_rid,
    ...
    input  logic             [  4:0] m_axi_hbm_3_bid,
    ...
    output logic             [  4:0] m_axi_hbm_4_awid,
    ...
    output logic             [  4:0] m_axi_hbm_4_arid,
    ...
    input  logic             [  4:0] m_axi_hbm_4_rid,
    ...
    input  logic             [  4:0] m_axi_hbm_4_bid,
    ...
    output logic             [  4:0] m_axi_hbm_5_awid,
    ...
    output logic             [  4:0] m_axi_hbm_5_arid,
    ...
    input  logic             [  4:0] m_axi_hbm_5_rid,
    ...
    input  logic             [  4:0] m_axi_hbm_5_bid,
    ...
    output logic             [  4:0] m_axi_hbm_6_awid,
    ...
    output logic             [  4:0] m_axi_hbm_6_arid,
    ...
    input  logic             [  4:0] m_axi_hbm_6_rid,
    ...
    input  logic             [  4:0] m_axi_hbm_6_bid,
    ...
    output logic             [  4:0] m_axi_hbm_7_awid,
    ...
    output logic             [  4:0] m_axi_hbm_7_arid,
    ...
    input  logic             [  4:0] m_axi_hbm_7_rid,
    ...
    input  logic             [  4:0] m_axi_hbm_7_bid,
  ...
  // PCIe //
  //////////
  axi_a48_d64_i7_u5_req_t  pcie_axi_req_o;
  axi_a48_d64_i7_u5_resp_t pcie_axi_rsp_i;
  ...
  // HBM //
  /////////
  axi_a48_d512_i5_u0_req_t  hbm_0_req_o;
  axi_a48_d512_i5_u0_resp_t hbm_0_rsp_i;

  // Assign structs to flattened ports
  `AXI_FLATTEN_MASTER(hbm_0, hbm_0_req_o, hbm_0_rsp_i)
  axi_a48_d512_i5_u0_req_t  hbm_1_req_o;
  axi_a48_d512_i5_u0_resp_t hbm_1_rsp_i;

  // Assign structs to flattened ports
  `AXI_FLATTEN_MASTER(hbm_1, hbm_1_req_o, hbm_1_rsp_i)
  axi_a48_d512_i5_u0_req_t  hbm_2_req_o;
  axi_a48_d512_i5_u0_resp_t hbm_2_rsp_i;

  // Assign structs to flattened ports
  `AXI_FLATTEN_MASTER(hbm_2, hbm_2_req_o, hbm_2_rsp_i)
  axi_a48_d512_i5_u0_req_t  hbm_3_req_o;
  axi_a48_d512_i5_u0_resp_t hbm_3_rsp_i;

  // Assign structs to flattened ports
  `AXI_FLATTEN_MASTER(hbm_3, hbm_3_req_o, hbm_3_rsp_i)
  axi_a48_d512_i5_u0_req_t  hbm_4_req_o;
  axi_a48_d512_i5_u0_resp_t hbm_4_rsp_i;

  // Assign structs to flattened ports
  `AXI_FLATTEN_MASTER(hbm_4, hbm_4_req_o, hbm_4_rsp_i)
  axi_a48_d512_i5_u0_req_t  hbm_5_req_o;
  axi_a48_d512_i5_u0_resp_t hbm_5_rsp_i;

  // Assign structs to flattened ports
  `AXI_FLATTEN_MASTER(hbm_5, hbm_5_req_o, hbm_5_rsp_i)
  axi_a48_d512_i5_u0_req_t  hbm_6_req_o;
  axi_a48_d512_i5_u0_resp_t hbm_6_rsp_i;

  // Assign structs to flattened ports
  `AXI_FLATTEN_MASTER(hbm_6, hbm_6_req_o, hbm_6_rsp_i)
  axi_a48_d512_i5_u0_req_t  hbm_7_req_o;
  axi_a48_d512_i5_u0_resp_t hbm_7_rsp_i;
